...
public class SDKUtil {
    ...
    public static com.alibaba.fastjson.JSONArray convert2JsonArray(String jsonBody) {

        com.alibaba.fastjson.JSONObject jsonObj = com.alibaba.fastjson.JSONObject
            .parseObject(jsonBody);
        return jsonObj.getJSONArray("data");
    }

    public static com.alibaba.fastjson.JSONObject convert2JsonObject(String jsonBody) {
