...
public class Video {
    ...
    public Video(String swfLink, int sourceFileSize, int status, String tag, int seed,
                 int playerWidth, List<Long> fileSize, String duration, String title, int df,
                 String firstImage, int times, String context, String originalDefinition,
                 int playerHeight, String vid, String ptime, long cataid) {
        super();
    ...
    public static Video formatJSONObject(JSONObject jsonObject) {
        ...
        Video Video = new Video(swfLink, sourceFileSize, status, tag, seed, playerWidth, fileSize,
            duration, title, df, firstImage, times, context, originalDefinition, playerHeight, vid,
            ptime, cataid);
