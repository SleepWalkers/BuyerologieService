...
public class PolyvClient {
    ...
    public String upload() {
        if (polyvBlockUploader == null)
            polyvBlockUploader = new PolyvBlockUploader("0", filename, cataid + "", title, tag,
                vid, PolyvSDKClient.getInstance().getUserid(), writeToken, new JSONObjectRet() {
                    ...
                    public void onPersist(JsonNode obj) {
                        ...
                        File configFile = new File(System.getProperty("user.dir") + File.separator
                                                   + polyvBlockUploader.getInfofileParent()
                                                   + File.separator
                                                   + polyvBlockUploader.getBucketName()
                                                   + File.separator + key
