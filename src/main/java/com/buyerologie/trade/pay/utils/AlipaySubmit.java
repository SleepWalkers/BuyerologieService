...
import com.buyerologie.trade.pay.utils.httpClient.HttpProtocolHandler;
import com.buyerologie.trade.pay.utils.httpClient.HttpRequest;
import com.buyerologie.trade.pay.utils.httpClient.HttpResponse;
import com.buyerologie.trade.pay.utils.httpClient.HttpResultType;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod,
        ...
        return buildRequest(null, sParaTemp, strMethod, strButtonName);
    }

    public static String buildRequest(String alipayGateWay, Map<String, String> sParaTemp,
                                      String strMethod, String strButtonName) {

        if (StringUtils.isBlank(alipayGateWay)) {
            alipayGateWay = ALIPAY_GATEWAY_NEW;
        }
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
